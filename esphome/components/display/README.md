...
-  [SSD1306 OLED](esphome/components/display/ssd1306)
...
以分辨率为128x64的[ssd1306 oled](esphome/components/display/ssd1306) 为例，左上角为原点，坐标为[x=0,y=0]，右下角为最远处，坐标为 [x=128,y=64]
