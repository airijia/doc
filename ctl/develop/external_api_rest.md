...
默认在 `8123` 端口运行的 Hass(Home Assistant) 提供 REST API 服务。假设智能中枢运行的 IP 为 `192.168.1.201`，[http://192.168.1.201:8123/api/](http://192.168.1.201:8123/api/) 即为服务地址
...
-  [怎样用通俗的语言解释REST？](//www.zhihu.com/question/28557115)
-  [基于 REST 的 Web 服务](//www.ibm.com/developerworks/cn/webservices/ws-restful/index.html)
