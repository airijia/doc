...
- **on_tag** (*Optional*, [自动化](mqtt/guides/automations)): An automation to perform when a tag is read. See [on_tag](https://esphomelib.com/esphomeyaml/components/pn532.html#pn532-on-tag).
